 ...
 * @author tokoo
 **/
function multimarket_testimonials_get_link() {
	$meta 	= multimarket_get_meta( '_testimonials_details', true );
 ...
 * @author tokoo
 **/
function multimarket_testimonials_get_position() {
	$meta 		= multimarket_get_meta( '_testimonials_details', true );
 ...
 * @author tokoo
 **/
function multimarket_testimonials_get_content() {
	$meta 		= multimarket_get_meta( '_testimonials_details', true );
 ...
 * @author tokoo
 **/
function multimarket_testimonials_get_rating() {
	$meta 		= multimarket_get_meta( '_testimonials_details', true );
