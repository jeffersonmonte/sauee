 ...
 * @author tokoo
 **/
function multimarket_team_get_role() {
	$meta 	= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
 ...
 * @author tokoo
 **/
function multimarket_team_get_social_account_array() {
	$meta 			= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
 ...
 * @author tokoo
 **/
function multimarket_team_social_accounts() {
	$meta 				= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
 ...
 * @author tokoo
 **/
function multimarket_team_get_biography() {
	$meta 		= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
 ...
 * @author tokoo
 **/
function multimarket_team_get_skills_array() {
	$meta 	= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
 ...
 * @author tokoo
 **/
function multimarket_team_skills() {
	$meta 		= get_post_meta( get_the_ID(), 'multimarket_team_details', true );
