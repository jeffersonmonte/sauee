...
<?php endif; ?>
		...
		<form method="post" class="login">
			<header class="section-header">
				<h2 class="section-title"><?php esc_html_e( 'Login', 'multimarket' ); ?></h2>
			</header>
			...
			<p class="woocommerce-LostPassword lost_password">
				<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'multimarket' ); ?></a>
			</p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			<header class="section-header">
				<h2 class="section-title"><?php esc_html_e( 'Register', 'multimarket' ); ?></h2>
			</header>
