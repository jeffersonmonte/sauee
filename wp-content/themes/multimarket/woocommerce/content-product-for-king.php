	...
	<div class="product__inner">
		...
		<figure class="product__image">
			...
			<div class="product__action">
				<a href="<?php the_permalink(); ?>" class="button buy-now"><span><?php esc_html_e( 'Buy Now', 'multimarket' ); ?></span></a>
			</div>
		</figure>
		...
		<?php if ( function_exists( 'wcbs_sales_countdown_display_content' ) ) : ?>
			<?php wcbs_sales_countdown_display_content(); ?>
		<?php endif; ?>
	</div>
</div>
