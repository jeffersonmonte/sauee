...
<div id="product-<?php the_ID(); ?>" <?php post_class( "deal-end-soon" ); ?>>
		...
		<div class="book-images">
			<div class="book">
				...
				<div class="book__page book__page--back">
					<?php if ( ! empty( $get_back_cover_img ) ) : ?>
						<img src="<?php echo esc_url( $back_cover_img_src[0] ); ?>" alt="<?php esc_html_e( 'Back Cover', 'multimarket' ); ?>">
					<?php endif; ?>
				</div>
			...
			<div class="book__action">
				<button class="see-back">
					...
					<span><?php esc_html_e( 'Flip to Back', 'multimarket' ); ?></span>
				</button>
			</div>
		</div>
		<!-- <div class="book"> -->
	...
	<div class="product-overview__summary">
		...
		<div class="product-action">
			<a href="<?php the_permalink(); ?>" class="single_add_to_cart_button button alt"><?php esc_html_e( 'See Details', 'multimarket' ); ?></a>
		</div>
	</div><!-- .summary -->
