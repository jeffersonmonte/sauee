					...
					<div class="row padding-30">
						<div class="col-md-6">
							...
							<div class="latest-archive">
								<h3><?php esc_html_e( 'Last 20 Posts', 'multimarket' ); ?></h3>
							...
							<div class="month-archive">
								<h3><?php esc_html_e( 'Monthly Archives', 'multimarket' ); ?></h3>
								<ul class="archive-list">
									<?php
							...
							<div class="page-archive">
								<h3><?php esc_html_e( 'Page Archives', 'multimarket' ); ?></h3>
								<ul class="archive-list">
						...
						<div class="col-md-6">
							...
							<div class="cat-archive">
								<h3><?php esc_html_e( 'Categories', 'multimarket' ); ?></h3>
								<ul class="archive-list">
