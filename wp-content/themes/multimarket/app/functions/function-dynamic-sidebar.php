 ...
 * @author tokoo
 **/
function multimarket_maybe_has_sidebar_left() {

	$page_layout 	= theme_layouts_get_layout();
	$get_sidebar 	= multimarket_get_meta( '_layouts_details' );
 ...
 * @author tokoo
 **/
function multimarket_maybe_has_sidebar_right() {
 ...
 * @author tokoo
 **/
function multimarket_maybe_has_sidebar( $default = 'multimarket-primary' ) {
