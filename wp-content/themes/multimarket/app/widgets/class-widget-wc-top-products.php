...
class Pustaka_WC_Top_Products extends Tokoo_Widget {
	...
	function __construct() {
		...
		$args = array(
			'label' 		=> esc_html__( 'WooCommerce Top Product', 'multimarket' ),
			'description' 	=> esc_html__( 'A custom widget to display best selling product', 'multimarket' ),
		 );
		...
		$args['fields'] = array(
			...
			array(
				...
				'type' 		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> esc_html__( 'Top Products', 'multimarket' ),
				'validate' 	=> 'alpha_dash',
			...
			array(
				...
				'desc' 		=> esc_html__( 'Limit product display', 'multimarket' ),
				'id' 		=> 'limit',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> '5',
			...
			array(
				'name' 		=> esc_html__( 'Show Image', 'multimarket' ),
				'desc' 		=> esc_html__( 'Show product image', 'multimarket' ),
				'id' 		=> 'show_image',
				'type'		=> 'checkbox',
				'class' 	=> 'widefat',
				'std' 		=> 0,
