...
class Multimarket_Social_Connect extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' 	=> esc_html__( 'A custom widget to display the social network icons.', 'multimarket' )
		);
		...
		parent::__construct( 'multimarket_Social_Connect', esc_html__( 'Tokoo - Social Connect', 'multimarket' ), $widget_ops, $control_ops );
	...
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'multimarket' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
	</p>
	<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'description' ) ); ?>"><?php esc_html_e( 'Description:', 'multimarket' ); ?></label>
	...
	<div class="widget-controls columns-2">
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Type:', 'multimarket' ); ?></label>
			<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'type' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>">
				<option value="normal" <?php selected( $type, 'normal' ); ?>><?php esc_html_e( 'Normal', 'multimarket' ); ?></option>
				<option value="boxed" <?php selected( $type, 'boxed' ); ?>><?php esc_html_e( 'Boxed', 'multimarket' ); ?></option>
				<option value="rounded" <?php selected( $type, 'rounded' ); ?>><?php esc_html_e( 'Rounded', 'multimarket' ); ?></option>
			</select>
		</p>
	</div>
	<div class="widget-controls columns-2 column-last">
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e( 'Size:', 'multimarket' ); ?></label>
			<select class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'size' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>">
				<option value="large" <?php selected( $size, 'large' ); ?>><?php esc_html_e( 'Large', 'multimarket' ); ?></option>
				<option value="medium" <?php selected( $size, 'medium' ); ?>><?php esc_html_e( 'Medium', 'multimarket' ); ?></option>
				<option value="small" <?php selected( $size, 'small' ); ?>><?php esc_html_e( 'Small', 'multimarket' ); ?></option>
			</select>
		</p>
	</div>
	...
	<div class="widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fb_id' ) ); ?>"><?php esc_html_e( 'Facebook Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_id' ) ); ?>"><?php esc_html_e( 'Twitter Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'gplus_id' ) ); ?>"><?php esc_html_e( 'Google Plus Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin_id' ) ); ?>"><?php esc_html_e( 'Linkedin Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'spotify_id' ) ); ?>"><?php esc_html_e( 'Spotify Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'codepen_id' ) ); ?>"><?php esc_html_e( 'Codepen Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'digg_id' ) ); ?>"><?php esc_html_e( 'Digg Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'foursquare_id' ) ); ?>"><?php esc_html_e( 'Foursquare Username:', 'multimarket' ); ?></label>
	...
	<div class="widget-controls columns-3">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'github_id' ) ); ?>"><?php esc_html_e( 'Github Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'reddit_id' ) ); ?>"><?php esc_html_e( 'Reddit Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'skype_id' ) ); ?>"><?php esc_html_e( 'Skype Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'behance_id' ) ); ?>"><?php esc_html_e( 'Behance Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'ytube_id' ) ); ?>"><?php esc_html_e( 'Youtube Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'steam_id' ) ); ?>"><?php esc_html_e( 'Steam Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'dribbble_id' ) ); ?>"><?php esc_html_e( 'Dribbble Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr_id' ) ); ?>"><?php esc_html_e( 'Tumblr Username:', 'multimarket' ); ?></label>
	...
	<div class="widget-controls columns-3 column-last">
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'wordpress_id' ) ); ?>"><?php esc_html_e( 'WordPress Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram_id' ) ); ?>"><?php esc_html_e( 'Instagram Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest_id' ) ); ?>"><?php esc_html_e( 'Pinterest Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'flickr_id' ) ); ?>"><?php esc_html_e( 'Flickr Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo_id' ) ); ?>"><?php esc_html_e( 'Vimeo Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vine_id' ) ); ?>"><?php esc_html_e( 'Vine Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'deviantart_id' ) ); ?>"><?php esc_html_e( 'Deviantart Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'lastfm_id' ) ); ?>"><?php esc_html_e( 'Last FM Username:', 'multimarket' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud_id' ) ); ?>"><?php esc_html_e( 'Soundcloud Username:', 'multimarket' ); ?></label>
