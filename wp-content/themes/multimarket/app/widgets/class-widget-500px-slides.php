 ...
 */
class Multimarket_500px_Photo_Slides extends WP_Widget {

	protected $defaults = array(
		'widget_id'                 => 'widget_500px_slides',
		'title'                     => '500px Photo Slides',
	...
	public function __construct() {
		parent::__construct(
			...
			'Tokoo - 500px Photo Slides',
			array(
				'description'   => 'Displays photos from 500px.com in slides display',
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $html ) ){
			...
			if ( is_array( $photos ) ) {
				$html .= '<div class="koo-image-slider 500px-slide">';
	...
	public function getHTML( $photos = array(), $args = array() ) {
		...
		ob_start();
			...
			foreach( $photos['photos'] as $photo ) {
				echo '<li><a href="http://500px.com/photo/'.$photo['id'].'" target="_blank" rel="nofollow" title="'.$photo['name'].'"><img src="'.$photo['image_url'].'" width="'.$width.'" height="'.$height.'" alt="'.$photo['name'].'" /></a></li>';
			$count++; }
