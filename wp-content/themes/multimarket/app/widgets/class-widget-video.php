...
class Multimarket_Video extends Tokoo_Widget {

	function __construct() {

		$args = array(
			'label' 		=> esc_html__( 'Tokoo - Video', 'multimarket' ),
			'description' 	=> esc_html__( 'A custom widget to display video such as from youtube, vimeo and etc.', 'multimarket' ),
		 );
		...
		$args['fields'] = array(
			...
			array(
				...
				'type' 		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> esc_html__( 'Video', 'multimarket' ),
				'validate' 	=> 'alpha_dash',
			 ...
			 // Show Post Count
			array(
				'name' 		=> esc_html__( 'Video URL', 'multimarket' ),
				'desc' 		=> esc_html__( 'Enter video URL', 'multimarket' ),
				'id' 		=> 'video_url',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> '',
