...
class Multimarket_Banner_Image extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'multimarket_Banner_Image', // Base ID
			esc_html__( 'Tokoo - Banner Image / Advertisement', 'multimarket' ), // Name

			array(
				'classname' => 'widget-advertisement no-padding ads-block',
				'description' => esc_html__( 'A widget to display banner image attachment', 'multimarket' )
			) // Args
		);
	}
		...
		?>
			...
			<div class="ads-wrapper">
				<a href="<?php echo esc_url( $instance['link'] ); ?>">
					<img src="<?php echo esc_url( multimarket_resize( $image_uri, $img_width, $img_height ) ); ?>" width="<?php echo esc_attr( $img_width ); ?>" height="<?php echo esc_attr( $img_height ); ?>" alt="<?php echo esc_attr( $title ); ?>" />
				</a>
			</div>
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'New title', 'multimarket' );
		}
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'multimarket' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"><?php esc_html_e( 'Link', 'multimarket' ); ?></label><br />
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'image_size' ) ); ?>"><?php esc_html_e( 'Size', 'multimarket' ); ?></label><br />
			...
			<?php esc_html_e( 'Set the banner image size <code>Ex: 406x338</code>', 'multimarket' ); ?>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'image_uri' ) ); ?>"><?php esc_html_e( 'Image', 'multimarket' ); ?></label><br />
			<img class="custom_media_image" src="<?php echo esc_url( $image_uri ); ?>" />
		...
		<p>
			<input type="button" value="<?php esc_html_e( 'Upload Image', 'multimarket' ); ?>" class="button custom_media_upload" id="custom_image_uploader"/>
		</p>
		<?php
	}
