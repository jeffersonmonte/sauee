...
class Multimarket_Recent_Comment_Avatar extends Tokoo_Widget {

	function __construct() {

		$args = array(
			'label' 		=> esc_html__( 'Tokoo - Recent Comments with Avatar', 'multimarket' ),
			'description' 	=> esc_html__( 'A custom widget to display recent comments with avatars', 'multimarket' ),
		 );
		...
		$args['fields'] = array(
			...
			array(
				...
				'type' 		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> esc_html__( 'Recent Comments With Avatar', 'multimarket' ),
				'validate' 	=> 'alpha_dash',
			...
			// Number
			array(
				'name' 		=> esc_html__( 'Number', 'multimarket' ),
				'id' 		=> 'number',
				'type'		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> 5,
		...
		?>
			...
			<?php
				...
				?>
					...
					<li><?php esc_html_e( 'No comments.', 'multimarket' ); ?></li>
