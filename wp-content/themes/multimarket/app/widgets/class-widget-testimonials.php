...
class Multimarket_Testimonials extends Tokoo_Widget {

	function __construct() {

		$args = array(
			'label' 		=> esc_html__( 'Tokoo - Testimonials', 'multimarket' ),
			'description' 	=> esc_html__( 'A custom widget that display three testimonials.', 'multimarket' ),
		 );
		...
		$args['fields'] = array(
			...
			array(
				...
				'type' 		=> 'text',
				'class' 	=> 'widefat',
				'std' 		=> esc_html__( 'Testimonials', 'multimarket' ),
				'validate' 	=> 'alpha_dash',
	...
	function widget( $args, $instance ) {
		...
		if ( $query->have_posts() ) :
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				$testimony = get_post_meta( get_the_ID(), 'multimarket_testimonials_details', true ); ?>
